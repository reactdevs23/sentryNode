...
import { secure } from "../../../images/images";
import styles from "./styles.module.css";
const ReliableSecureAndFast = () => {
  const facilities = [
  ...
  return (
    <div className={[styles.container, styles.gridChange].join(" ")}>
      ...
      <div className={styles.facilitiesContainer}>
        <h3 className={styles.title}>Reliable, Secure & Fast</h3>
      ...
      <div className={styles.imageContainer}>
        <img src={secure} alt="#" className={styles.image} />
      </div>
    </div>
  );
};

export default ReliableSecureAndFast;
